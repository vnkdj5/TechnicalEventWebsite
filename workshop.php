		...
		<section id="uxui" class="uxui bg-radial-black-left">
			<div class="inner">
				<div class="chunk-left">
					<img class="flex" src="img/iot.png">
				</div>
				
				<div class="chunk-right">
					<h1 class="small">IoT</h1>
					<h4 class="subtitle"  style="font-size:24px;text-align:justify;">
Workshop will be first step towards journey of thousand miles in the field of
professional IoT development landscape. It will give good overview of domain and
future prospects in the field of IoT.
  .</h4>
  <h3>
  <ul style="text-align:left;">
  <li>Venue : Pune Institute of Computer Technology, Pune</li>
  <li>Workshop fee : ₹ 1100/- per participant</li>
  <li>Date : 16<sup>th</sup> &amp; 17<sup>th</sup> September</li>
  </ul>
  <br>
  <center>
  <a class="button red inverted " href="register.php">Register Now</a>
  </center>
</h3>
				</div>
		...
		<section id="uxui" class="uxui bg-radial-blue-left">
			<div class="inner">
				<div class="chunk-left">
					<img class="flex" src="img/vr.png">
				</div>
				
				<div class="chunk-right">
					<h1 class="small" style="font-size:60px;">Virtual Reality</h1>
					<h4 class="subtitle" style="font-size:24px;text-align:justify;">

Interest in Virtual Reality (VR) is growing – don’t miss your chance to catch it
ahead of the curve. With major brands like YouTube and Facebook developing
platforms to support 360.</h4>
  <h3>
  <ul style="text-align:left;">
  <li>Venue : Pune Institute of Computer Technology, Pune</li>
  <li>Workshop fee : ₹ 1000/- per participant</li>
  <li>Date : 16<sup>th</sup> &amp; 17<sup>th</sup> September</li>
  </ul>
  <br>
  <center>
